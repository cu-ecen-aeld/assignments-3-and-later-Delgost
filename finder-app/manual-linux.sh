...
cp ${SCRIPT_DIR}/libraries/ld-linux-aarch64.so.1 ${OUTDIR}/rootfs/lib/
cp ${SCRIPT_DIR}/libraries/libm.so.6 ${OUTDIR}/rootfs/lib64/
cp ${SCRIPT_DIR}/libraries/libresolv.so.2 ${OUTDIR}/rootfs/lib64/
cp ${SCRIPT_DIR}/libraries/libc.so.6 ${OUTDIR}/rootfs/lib64/
